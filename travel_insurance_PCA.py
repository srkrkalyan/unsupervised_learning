...
pca_x_scaled = PCA(n_components = 5)
...
plt.title('k-means clustering on PCA transformed dataset - Travel Insurance Dataset')
plt.xlabel('PCA 0')
plt.ylabel('PCA 1')
plt.legend()
plt.show()
...
plt.title('EM clustering on PCA transformed dataset - Travel Insurance Dataset')
plt.xlabel('PCA 0')
plt.ylabel('PCA 1')
plt.legend()
plt.show()
...
#Running ANN on transformed data sets
...
#Running ANN on transformed data sets with labels generated by k-means clustering algorithm
...
#Running ANN on transformed data sets with labels generated by GMM clustering algorithm

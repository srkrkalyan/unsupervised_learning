...
scipy.stats.kurtosis(X_scaled_transformed[:,0],axis=0,fisher=True,bias=True)
...
# ANN run on featured transformed data set
...
# ANN run on feature transformed + k-means clustering dataset
...
# ANN run on feature transformed + EM clustering dataset

...
plt.title('k-means clustering on SVD transformed dataset - Travel Insurance Dataset')
plt.xlabel('SVD 0')
plt.ylabel('SVD 1')
plt.legend()
plt.show()
...
plt.title('EM clustering on SVD transformed dataset - Travel Insurance Dataset')
plt.xlabel('SVD 0')
plt.ylabel('SVD 1')
plt.legend()
plt.show()
...
# ANN run on feature transformed + K-means clustering data set
...
# ANN run on feature transformed + EM clustering data set
